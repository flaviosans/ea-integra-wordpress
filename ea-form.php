    ...
    <div class="row">
        <form action="<?php echo $api_url ?>/budget" id="ea-form<?php echo $unique_id ?>" method="POST" onsubmit="handleFormSubmit(event, this)">
            <fieldset class="ea-step step<?php echo $unique_id ?> <?php echo $css_container ?>" >
                <div class="<?php echo $css_row ?>">
                    <div class="ea-step-title <?php echo $css_full_col ?>">
                        <h3>Onde será feito o trabalho?</h3>
            ...
            <fieldset class="ea-step step<?php echo $unique_id ?> <?php echo $css_container ?>">
                <div class="<?php echo $css_row ?>">
                    <div class="ea-step-title <?php echo $css_full_col ?>">
                        <h3>O orçamento que você deseja se encaixa em qual categoria?</h3>
            ...
            <fieldset class="ea-step step<?php echo $unique_id ?> <?php echo $css_container ?>">
                <div class="<?php echo $css_row ?>">
                    <div class="ea-step-title <?php echo $css_full_col ?>">
                        <h3>Queremos saber um pouco mais sobre seu pedido</h3>
                        <div class="ea-warning">Confira os campos</div>
                    </div>
            ...
            <fieldset class="ea-step step<?php echo $unique_id ?> <?php echo $css_container ?>">
                <div class="<?php echo $css_row ?>">
                    <div class="ea-step-title">
                        <div class="ea-wait">
                            <h3>Aguarde, estamos gravando a sua solicitação...</h3>
                        </div>
                        <div class="ea-success ea-hidden">
                            <h3>Obrigado pelo orçamento!</h3>
                        </div>
